...
% Loading data.
load VORTALL_CONFINED_LY5_SYMM.mat

% Creating data matrix . 
X = VORTALL_CONFINED_LY5_SYMM;
...
AnimateSquare(VORT_stack,'Square_flow_confined_recreated_anim.gif');
...
ME_CON_LY5 = energy_cap; 
save("Mode_energy","ME_CON_LY5",'-append');